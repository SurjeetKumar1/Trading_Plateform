  ...
  return (
    <div className="conatiner">
      <div className="row p-5 mt-5 mb-2">
        <h1 className="fs-2 ">To create a ticket, select a relevent topics </h1>
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=" ">
            <i class="fa fa-plus-circle" aria-hidden="true"  style={{fontSize:"1rem", marginRight:"0.3rem"}}></i> Account Opening{" "}
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=" ">
          <i class="fa-solid fa-user" style={{fontSize:"1rem", marginRight:"0.3rem"}}></i> Your Zerodha Account{" "}
          </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=" ">
          <i class="fa-solid fa-chart-simple " style={{fontSize:"1rem", marginRight:"0.6rem"}}></i>Account Opening{" "}
          </h4>
          ...
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}> Pi and other platform</a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=" ">
            <i class="fa fa-plus-circle" aria-hidden="true" style={{fontSize:"1rem", marginRight:"0.3rem"}}></i> Funds{" "}
          </h4>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Online Account Opening </a><br/>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Offline Account Opening </a><br/>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Company, Partnership and HUF Account </a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=" ">
          <i class="fa-solid fa-user" style={{fontSize:"1rem", marginRight:"0.3rem"}}></i> Console{" "}
          </h4>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Account Modification and Segment Addition </a><br/>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>DP ID and bank details </a><br/>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Your Profile </a><br/>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className=" ">
          <i class="fa-solid fa-chart-simple" style={{fontSize:"1rem", marginRight:"0.6rem"}}></i>Coin{" "}
          </h4>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Margin/leverage, Product and Order types</a><br/>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Kite Web and Mobile </a><br/>
          <a href="/" style={{textDecoration:"none", lineHeight:"2.5"}}>Trading FAQs </a><br/>
