    ...
    return ( 
       <div className='container'>
        <div className='row mt-5 p-5  border-top'>
            ...
            <div className='col-8'>
               <a href="/" className='text-decoration-none text-center'><h3  className='fs-5'>Brokerage calculator</h3></a>
            ...
            <div className='col-4'>
            <a href="/" className='text-decoration-none text-center'> <h3 className='fs-5'>List of charges</h3></a>
            </div>
        </div>
       </div>
     );
